...
\item ordinamento delle sequenze:
    \begin{itemize}
        \item per $i \in \{1, \dots, N-1\}:$
        \begin{itemize}
            \item $(i < P_1) \implies (X_i < X_{i+1})$
            \item $(P_1 \leq i \land i < P_2) \implies (X_i > X_{i+1})$
            \item $(P_2 \leq i \land i < P_3) \implies (X_i < X_{i+1})$
            \item $(i \geq P_3) \implies (X_i > X_{i+1})$
        \end{itemize}
    \end{itemize}
